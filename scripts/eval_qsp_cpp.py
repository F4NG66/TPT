...
for datasetusing, csv_path in DataSetList.items():
    ...
    tiny_model_320.load_state_dict(torch.load("./Ablation/Hidden_dim/320/best_pretrain_10M.pt"))
    tiny_model_480.load_state_dict(torch.load("./Ablation/Hidden_dim/480/best_pretrain_10M.pt"))
    tiny_model_640.load_state_dict(torch.load("./Ablation/Hidden_dim/640/best_pretrain_10M.pt"))
    tiny_model_800.load_state_dict(torch.load("./Ablation/Hidden_dim/800/best_pretrain_10M.pt"))
