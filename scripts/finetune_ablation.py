...
from Ablation.tpt import TinyProteinTransformer as TinyProteinTransformerLoss loss
...
for  datasetusing in DataSetList:
    ...
    #####################################################################################
    # Ablation Model
    #tiny_model.load_state_dict(torch.load("./Ablation/TPT_Contrast_Weight/best_pretrain.pt"))
    #tiny_model.load_state_dict(torch.load("./Ablation/gate_TPT_Weight/best_pretrain.pt"))
    #tiny_model.load_state_dict(torch.load("./Ablation/TPT_Without_Attenpool_weight/best_pretrain_1M.pt"))
    #tiny_model.load_state_dict(torch.load("./Ablation/TPT_Without_CNN_Weight/best_pretrain.pt"))
    ...
    tiny_model_WOAtt.load_state_dict(torch.load("./Ablation/TPT_Without_Attenpool_weight/best_pretrain.pt"))
    tiny_model_WOCNN.load_state_dict(torch.load("./Ablation/TPT_Without_CNN_Weight/best_pretrain.pt"))
