    ...
    for hidden_dim in  hidden_dim_list:
     # 256 512 1024  
        ...
        for epoch in range(start_epoch, EPOCHS):
            ...
            save_loss_plot(log_dict,fname=f"./VisulPlot/{hidden_dim}_pretrain_loss.png")
            ...
            torch.save(state, f"./Ablation/Hidden_dim/{hidden_dim}/checkpoint.pt")
            print("Saved checkpoint.pt")

            if avg_loss < best_loss:
                best_loss = avg_loss
                torch.save(state["model"], f"./Ablation/Hidden_dim/{hidden_dim}/best_pretrain.pt")
